...
export const Counter = () => {
    ...
    // const count = useSelector(({ counterReducer }) => counterReducer.count);
    ...
    return (
        <div>
            ...
            <input type="text" onChange={handleChangeInputNumber} placeholder="Input Number" value={inputNumber} />
        </div>
    )
}